...
return array(
    ...
    */
    ...
    'selection' => array(
        ...
        'contrast_1_padj_SE_SOX10_vs_SE_neg' => array(
        ...
        'contrast_2_padj_PE_SOX10_vs_PE_neg' => array(
        ...
        'contrast_3_padj_SE_SOX10_vs_PE_SOX10' => array(
            'name' => 'padj SE SOX10 vs PE SOX10',
            'slider_min' => 0,
            'slider_max' => 1,
            'default_low' => 0,
            'default_high' => 1
        ),
        'contrast_4_padj_SE_neg_vs_PE_neg' => array(
            'name' => 'padj SE neg vs PE neg',
            'slider_min' => 0,
            'slider_max' => 1,
            'default_low' => 0,
            'default_high' => 1
        ),
        'contrast_L_lg10p_LRT_PE_SE' => array(
            'name' => 'lg10p LRT PE SE',
            'slider_min' => 0,
            'slider_max' => 10,
            'default_low' => 0,
            'default_high' => 10
    ...
    'scatterplot' => array(
        'default-x' => 'contrast_1_logFC_SE_SOX10_vs_SE_neg',
        'default-y' => 'contrast_2_logFC_PE_SOX10_vs_PE_neg',
        'selection' => array(
            'contrast_1_logFC_SE_SOX10_vs_SE_neg' => array(
                'name' => 'logFC SE SOX10 vs SE neg'
            ),
            ...
            'contrast_3_lg10p_SE_SOX10_vs_PE_SOX10' => array(
                'name' => 'lg10p SE SOX10 vs PE SOX10'
            ),
            'contrast_4_lg10p_SE_neg_vs_PE_neg' => array(
                'name' => 'lg10p SE neg vs PE neg'
            ),
            'contrast_L_lg10p_LRT_PE_SE' => array(
                'name' => 'lg10p LRT PE SE'
            ),
