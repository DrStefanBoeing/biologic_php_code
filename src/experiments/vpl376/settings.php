...
return array(
    ...
    */
    ...
    'data_db' => array(
            'cat_table_name' => 'vpl376_cat_reference_db_table'
    ),

    'rnaseq_db_table' => 'vpl376_sc_rna_seq_table',
    ...
    'selection' => array(
        'contrast_A_bulkRNASeq_vpl308_logFC_PE_SOX10_vs_PE_neg' => array(
            'name' => 'bulkRNASeq vpl308 logFC PE SOX10 vs PE neg',
            'slider_min' => -7,
            'slider_max' => 8,
            'default_low' => -7,
            'default_high' => 8
        ),
        'contrast_A_bulkRNASeq_vpl308_lg10p_PE_SOX10_vs_PE_neg' => array(
            'name' => 'bulkRNASeq vpl308 lg10p PE SOX10 vs PE neg',
            'slider_min' => 0,
            'slider_max' => 25,
            'default_low' => 0,
            'default_high' => 25
        ),
        'contrast_A_bulkRNASeq_vpl308_padj_PE_SOX10_vs_PE_neg' => array(
            'name' => 'bulkRNASeq vpl308 padj PE SOX10 vs PE neg',
            'slider_min' => 0,
            'slider_max' => 1,
            'default_low' => 0,
            'default_high' => 1
        ...
        'contrast_1_logFC_Glia_vs_Neuron' => array(
            'name' => 'logFC Glia vs Neuron',
            'slider_min' => -3,
            'slider_max' => 2,
            'default_low' => -3,
            'default_high' => 2
