...
return array(
    ...
    */
    ...
    'data_db' => array(
            'cat_table_name' => 'RN20047_cat_reference_db_table'
    ),

    'rnaseq_db_table' => 'RN20047_rna_seq_table',
    ...
    'samples' => array(
        'norm_counts_KO2_T0_S1_TPM' => array(
            'color' => '#F8766D',
            'name' => 'KO2 T0 S1 TPM'
        ),
        'norm_counts_KO2_T0_S2_TPM' => array(
            'color' => '#F8766D',
            'name' => 'KO2 T0 S2 TPM'
        ),
        'norm_counts_KO2_T0_S3_TPM' => array(
            'color' => '#F8766D',
            'name' => 'KO2 T0 S3 TPM'
        ),
        'norm_counts_KO2_T0_S4_TPM' => array(
            'color' => '#F8766D',
            'name' => 'KO2 T0 S4 TPM'
        ),
        'norm_counts_WT_T0_S1_TPM' => array(
            'color' => '#00BFC4',
            'name' => 'WT T0 S1 TPM'
        ),
        'norm_counts_WT_T0_S2_TPM' => array(
            'color' => '#00BFC4',
            'name' => 'WT T0 S2 TPM'
        ),
        'norm_counts_WT_T0_S3_TPM' => array(
            'color' => '#00BFC4',
            'name' => 'WT T0 S3 TPM'
        ),
        'norm_counts_WT_T0_S4_TPM' => array(
            'color' => '#00BFC4',
            'name' => 'WT T0 S4 TPM'
        ),
...
'KO2_T0' => array(
    'timepoint' =>  0,
    'sampleDbCols' =>  array(
'norm_counts_KO2_T0_S1_TPM','norm_counts_KO2_T0_S2_TPM','norm_counts_KO2_T0_S3_TPM','norm_counts_KO2_T0_S4_TPM'
)),
'KO2_T18' => array(
    'timepoint' =>  18,
    'sampleDbCols' =>  array(
...
'WT_T0' => array(
    'timepoint' =>  0,
    'sampleDbCols' =>  array(
'norm_counts_WT_T0_S1_TPM','norm_counts_WT_T0_S2_TPM','norm_counts_WT_T0_S3_TPM','norm_counts_WT_T0_S4_TPM'
)),
'WT_T18' => array(
    'timepoint' =>  18,
    'sampleDbCols' =>  array(
...
// New End: Timecourse
    ...
    'venn' => array(
        'experiments' => array('lg2_avg_KO2_T0_S1_TPM','lg2_avg_KO2_T0_S2_TPM','lg2_avg_KO2_T0_S3_TPM','lg2_avg_KO2_T0_S4_TPM','lg2_avg_WT_T0_S1_TPM','lg2_avg_WT_T0_S2_TPM','lg2_avg_WT_T0_S3_TPM','lg2_avg_WT_T0_S4_TPM','lg2_avg_KO2_T18_M1_TPM','lg2_avg_KO2_T18_M2_TPM','lg2_avg_KO2_T18_M3_TPM','lg2_avg_KO2_T18_M4_TPM','lg2_avg_WT_T18_M1_TPM','lg2_avg_WT_T18_M2_TPM','lg2_avg_WT_T18_M3_TPM','lg2_avg_WT_T18_M4_TPM','lg2_avg_KO2_T72_M1_TPM','lg2_avg_KO2_T72_M2_TPM','lg2_avg_KO2_T72_M3_TPM','lg2_avg_KO2_T72_M4_TPM','lg2_avg_WT_T72_M1_TPM','lg2_avg_WT_T72_M2_TPM','lg2_avg_WT_T72_M3_TPM','lg2_avg_WT_T72_M4_TPM'),
    ...
    'selection' => array(
        'contrast_1_logFC_KO2_T0_vs_WT_T0' => array(
            'name' => 'logFC KO2 T0 vs WT T0',
            'slider_min' => -7,
            'slider_max' => 3,
            'default_low' => -7,
            'default_high' => 3
        ),
        'contrast_1_padj_KO2_T0_vs_WT_T0' => array(
            'name' => 'padj KO2 T0 vs WT T0',
            'slider_min' => 0,
            'slider_max' => 1,
            'default_low' => 0,
            'default_high' => 1
        ),
        'contrast_2_logFC_KO2_T18_vs_WT_T18' => array(
        ...
        'contrast_2_padj_KO2_T18_vs_WT_T18' => array(
        ...
        'contrast_3_logFC_KO2_T72_vs_WT_T72' => array(
        ...
        'contrast_3_padj_KO2_T72_vs_WT_T72' => array(
        ...
        'contrast_4_logFC_KO2_vs_WT' => array(
        ...
        'contrast_4_padj_KO2_vs_WT' => array(
            'name' => 'padj KO2 vs WT',
            'slider_min' => 0,
            'slider_max' => 1,
            'default_low' => 0,
...
'pca' => 'RN20047_PCA',
    // Scatterplot Parameters
    'scatterplot' => array(
        'default-x' => 'contrast_1_logFC_KO2_T0_vs_WT_T0',
        'default-y' => 'contrast_1_lg10p_KO2_T0_vs_WT_T0',
        'selection' => array(
            'contrast_1_logFC_KO2_T0_vs_WT_T0' => array(
                'name' => 'logFC KO2 T0 vs WT T0'
            ),
            ...
            'contrast_1_lg10p_KO2_T0_vs_WT_T0' => array(
                'name' => 'lg10p KO2 T0 vs WT T0'
            ),
            'contrast_2_lg10p_KO2_T18_vs_WT_T18' => array(
                'name' => 'lg10p KO2 T18 vs WT T18'
            ),
            'contrast_3_lg10p_KO2_T72_vs_WT_T72' => array(
                'name' => 'lg10p KO2 T72 vs WT T72'
            ),
            'contrast_4_lg10p_KO2_vs_WT' => array(
            ...
            'contrast_1_lg2BaseMean_KO2_T0_vs_WT_T0' => array(
                'name' => 'lg2BaseMean KO2 T0 vs WT T0'
            ),
            'contrast_2_lg2BaseMean_KO2_T18_vs_WT_T18' => array(
                'name' => 'lg2BaseMean KO2 T18 vs WT T18'
            ),
            'contrast_3_lg2BaseMean_KO2_T72_vs_WT_T72' => array(
                'name' => 'lg2BaseMean KO2 T72 vs WT T72'
            ),
            'contrast_4_lg2BaseMean_KO2_vs_WT' => array(
