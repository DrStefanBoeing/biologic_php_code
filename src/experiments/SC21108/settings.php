...
return array(
    ...
    * Experiment settings
    */
    'data_db_name' => 'jvl_data',
    'data_db' => array(
            'cat_table_name' => 'SC21108_cat_reference_db_table'
    ),

    'rnaseq_db_table' => 'SC21108_sc_rna_seq_table',
...
'pca' => 'SC21108_PCA',
    ...
    'scatterplot' => array(
        ...
        'selection' => array(
            ...
            'add_counts_Avg_log10_Expr_all_x' => array(
                'name' => 'Avg log10 Expr all x'
            ),
            'add_counts_Avg_log10_Expr_all_y' => array(
                'name' => 'Avg log10 Expr all y'
            ),
            'norm_counts_Avg_log10_Expr_C0' => array(
                'name' => 's Avg log10 Expr C0'
            ),
