...
return array(
    ...
    */
    ...
    'rnaseq_db_table' => 'p228_sc_rna_seq_table',
    ...
    'samples' => array(
        'norm_counts_Avg_lg10_Expr_C_0_GN' => array(
            'color' => '#F8766D',
            'name' => 'Avg lg10 Expr C 0 GN'
        ),
        'norm_counts_Avg_lg10_Expr_C_1_GN' => array(
            'color' => '#7CAE00',
            'name' => 'Avg lg10 Expr C 1 GN'
        ),
        'norm_counts_Avg_lg10_Expr_C_2_GN' => array(
            'color' => '#00BFC4',
            'name' => 'Avg lg10 Expr C 2 GN'
        ),
        'norm_counts_Avg_lg10_Expr_C_3_GN' => array(
            'color' => '#C77CFF',
            'name' => 'Avg lg10 Expr C 3 GN'
        )
    ), // End samples array
    // bar chart
    'count_table' => array(
    ...
    'venn' => array(
        'experiments' => array('lg2_avg_Avg_log10_Expr_Sc_C_0_GN','lg2_avg_Avg_log10_Expr_Sc_C_1_GN','lg2_avg_Avg_log10_Expr_Sc_C_2_GN','lg2_avg_Avg_log10_Expr_Sc_C_3_GN'),
...
'pca' => 'p228_PCA',
    ...
    'scatterplot' => array(
        ...
        'default-y' => 'norm_counts_Avg_lg10_Expr_C_0_GN',
        'selection' => array(
            'contrast_X_logFC_Expressed_in_N_Percent_Cells' => array(
                'name' => 'logFC Expressed in N Percent Cells'
            ),
            ...
            'norm_counts_Avg_lg10_Expr_C_0_GN' => array(
                'name' => 's Avg lg10 Expr C 0 GN'
            ),
            'norm_counts_Avg_lg10_Expr_C_1_GN' => array(
                'name' => 's Avg lg10 Expr C 1 GN'
            ),
            'norm_counts_Avg_lg10_Expr_C_2_GN' => array(
                'name' => 's Avg lg10 Expr C 2 GN'
            ),
            'norm_counts_Avg_lg10_Expr_C_3_GN' => array(
                'name' => 's Avg lg10 Expr C 3 GN'
            ),
            'add_counts_PCA_Dim_1_Loadings' => array(
                'name' => 'PCA Dim 1 Loadings'
            ),
